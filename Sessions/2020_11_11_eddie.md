...
lcd /exports/igmm/eddie/GenScotDepression/
lls
cd igmm/datastore/GenScotDepression/users/
ls
put -R example_folder_to_copy/
...
Links to tips [here](https://acarril.github.io/posts/ssh-sripts-st3#:~:text=Fire%20up%20ST3%20on%20your,52698)%20to%20your%20SSH%20connection.) and [here](http://blog.keyrus.co.uk/editing_files_on_a_remote_server_using_sublime.html).
```
